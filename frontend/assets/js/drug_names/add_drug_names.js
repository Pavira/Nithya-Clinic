...
function addRowBtnFunction(){
  ...
  addRowBtn.addEventListener("click", function () {
    ...
    newRow.innerHTML = `
      <div class="col-md-6">
        <select class="form-select" name="drugCategory" required></select>
      </div>
...
function addDrugNamesFunction() {
  ...
  form.addEventListener("submit", function (e) {
    ...
    form.querySelectorAll(".row").forEach(row => {
      ...
      if (drugName && drugCategoryId && drugCategoryName) {
    ...
    console.log("Submitting drug names:", drugNames, drugCategoryIds, drugCategoryNames);
