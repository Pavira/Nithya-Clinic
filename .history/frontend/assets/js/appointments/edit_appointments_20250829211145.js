...
function getPrescriptionTableData() {
  console.log("getPrescriptionTableData");
    ...
    rows.forEach((row, index) => {
        ...
        const timingFlags = {
            M: cells[4].innerText.trim() !== '' ? true : false,
            A: cells[5].innerText.trim() !== '' ? true : false,
            E: cells[6].innerText.trim() !== '' ? true : false,
            N: cells[7].innerText.trim() !== '' ? true : false,
            'B/F': cells[8].innerText.trim() !== '' ? true : false,
            'A/F': cells[9].innerText.trim() !== '' ? true : false
        };
