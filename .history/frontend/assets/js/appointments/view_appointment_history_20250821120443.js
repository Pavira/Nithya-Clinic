...
function printPdf() {
  document.getElementById("printPdfBtn").addEventListener("click", function () {
    ...
    // 🔎 Dynamically fetch patient name & appointment number
    const patientName = document.querySelector("#appointment_no")
      ?.closest("form")
      ?.querySelector('input[value][class*="bg-light"]')?.value || "Patient";
