...
function getPrescriptionTableData() {
  console.log("getPrescriptionTableData");
    ...
    rows.forEach((row, index) => {
        ...
        const timing_m = cells[4].innerText.trim() ?? 0;
        const timing_a = cells[5].innerText.trim() ?? 0;
        const timing_e = cells[6].innerText.trim() ?? 0;
        const timing_n = cells[7].innerText.trim() ?? 0;
        const timing_bf = cells[8].innerText.trim() ?? 0;
        const timing_af = cells[9].innerText.trim() ?? 0;
        ...
        tableData.push({
            ...
            M : timing_m === null || '' ? 0 : parseInt(timing_m),
            A : timing_a === null || '' ? 0 : parseInt(timing_a),
            E : timing_e === null || '' ? 0 : parseInt(timing_e),
            N : timing_n === null || '' ? 0 : parseInt(timing_n),
            "B/F" : timing_bf === null || '' ? 0 : parseInt(timing_bf),
            "A/F" : timing_af === null || '' ? 0 : parseInt(timing_af),
        });
    });
