...
function getPrescriptionTableData() {
  console.log("getPrescriptionTableData");
    ...
    rows.forEach((row, index) => {
        ...
        const timing-m = cells[4].innerText.trim()
        const timing- = cells[5].innerText.trim();
        const timing- = cells[6].innerText.trim();
        const timing- = cells[7].innerText.trim();
        const timing- = cells[8].innerText.trim();
        const timing- = cells[9].innerText.trim();
