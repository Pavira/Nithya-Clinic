...
function getPrescriptionTableData() {
  console.log("getPrescriptionTableData");
    ...
    rows.forEach((row, index) => {
        ...
        const timing_m = cells[4].innerText.trim()
        const timing_a = cells[5].innerText.trim();
        const timing_e = cells[6].innerText.trim();
        const timing_n = cells[7].innerText.trim();
        const timing_bf = cells[8].innerText.trim();
        const timing_af = cells[9].innerText.trim();
        ...
        tableData.push({
            ...
            morning: timing_m === null || '' ? 0 : parseInt(timing_m),
            afternoon: timing_a === null || '' ? 0 : parseInt(timing_a),
            evening: timing_e === null || '' ? 0 : parseInt(timing_e),
            night: timing_n === null || '' ? 0 : parseInt(timing_n),
            before_food: timing_bf === null || '' ? 0 : parseInt(timing_bf),
            after_food: timing_af === null || '' ? 0 : parseInt(timing_af),
        });
    });
