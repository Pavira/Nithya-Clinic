...
async function initPrescription() {
  ...
  document.querySelectorAll('.timing-toggle').forEach(button => {
    ...
    function resetPrescriptionForm() {
      ...
      document.getElementById('timing-m').value;
      document.getElementById('timing-a').value;
      document.getElementById('timing-e').value;
      document.getElementById('timing-n').value;
