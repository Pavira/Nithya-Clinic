  ...
  fetch(`/admin/pages/${relativePath}.html`)
    ...
    .then(html => {
      ...
      if (relativePath === "appointments/view_appointment_history") {
        if (window.currentPage && window.currentPage !== "appointments/edit_appointments") { window.appHistory.push({ page: window.currentPage, params: window.pageParams || {}, scrollY: window.scrollY }); }
